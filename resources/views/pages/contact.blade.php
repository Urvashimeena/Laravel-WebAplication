...
<body>
		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<li class="dropdown head-dpdn">
						<a href="/contact" class="dropdown-toggle"><i class="fa fa-map-marker" aria-hidden="true"></i> Contact Us</a>
					</li> 
	...
	<div class="copy-right"> 
		<div class="container">
			<p>© 2017 ShopoviA . All rights reserved | Design by ANKUSH , AVINASH & ABHIMANYU</p>
		</div>
	</div> 
	<!-- cart-js -->
