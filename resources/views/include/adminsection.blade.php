<?php
        ...
        $shopkeeper = Session::get('shopkeeper');
 ...
 ?> 
     	...
     	<div class="col_3">
        	...
        	<div class="col-md-4 widget widget1">
        		<div class="r3_counter_box">
                    ...
                    <div class="stats">
                      <h5><strong>{{$shopkeeper}}</strong></h5>
      ...
      <div class="col_1">
		  ...
		  <!----Calender -------->
			...
			<script src="js1/underscore-min.js" type="text/javascript"></script>
			<script src= "js1/moment-2.2.1.js" type="text/javascript"></script>
			<script src="js1/clndr.js" type="text/javascript"></script>
			<script src="js1/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
...
<script src="js1/jquery.vmap.js"></script>
