			...
			<div class="ftr-toprow">
				<div class="col-md-4 ftr-top-grids">
					...
					<div class="ftr-top-right">
						<h4>FREE DELIVERY</h4>
						<p>Free Shipping On Everything You Shop</p>
					</div> 
				...
				<div class="col-md-4 ftr-top-grids">
					...
					<div class="ftr-top-right">
						<h4>GOOD QUALITY</h4>
						<p>We Provide Good Quality.Because Quality is Not An Act Its Our Habit.<p>
					</div>
					<div class="clearfix"> </div>
				</div> 
				<div class="clearfix"> </div>
			...
			<div class="footer-info w3-agileits-info">
				<div class="col-md-4 address-left agileinfo">
					<div class="footer-logo header-logo">
						<h2><a href="/"><span>S</span>hopoviA </a></h2>
						<h6>Your stores. Your place.</h6>
					</div>
					<ul>
						<li><i class="fa fa-map-marker"></i> Kalka Mata Road,Ganesh nagar,Pahada</li>
						<li><i class="fa fa-mobile"></i>7698554185</li>
						<li><i class="fa fa-phone"></i>7568485638</li>
						<li><i class="fa fa-envelope-o"></i>Urvashimeena1998@gmail.com</li>
					</ul> 
				</div>
				<div class="col-md-8 address-right">
					<div class="col-md-4 footer-grids">
						<h3>Company</h3>
						<ul>
							<li><a data-toggle="modal" data-target="#modalabout" >About Us</a></li>
	...
	<div class="copy-right"> 
		<div class="container">
			<p>© 2017 ShopoviA . All rights reserved | Design by URVASHI MEENA</p>
		</div>
	</div> 
